...
import dev.jakub.fritzbox.exceptions.AuthenticationException;
import dev.jakub.fritzbox.exceptions.FritzboxException;
import dev.jakub.fritzbox.model.FritzBoxLanguage;
import dev.jakub.fritzbox.model.FritzOS;
import dev.jakub.fritzbox.model.InternetInfo;
import dev.jakub.fritzbox.model.LogEntry;
...
public class FritzBox {
    ...
    public HttpResponse<String> getDataPostResponse(Map<String, String> postParams) {
        try {
            ...
            // Build query parameters from the given map
            ...
            // If any parameters converted from the given map,
            // cut the first ampersand.
